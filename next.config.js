    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://static.cloudflareinsights.com https://www.gigaaura.com https://*.pusher.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https://*.gigaaura.com https://i.pravatar.cc https://picsum.photos https://images.unsplash.com https://*.googleapis.com https://*.gstatic.com; connect-src 'self' https://*.gigaaura.com wss://ws-us2.pusher.com http://*.pusher.com https://*.pusher.com ws://*.pusher.com wss://*.pusher.com http://sockjs-*.pusher.com https://sockjs-*.pusher.com ws://sockjs-*.pusher.com wss://sockjs-*.pusher.com http://ws-*.pusher.com https://ws-*.pusher.com ws://ws-*.pusher.com wss://ws-*.pusher.com http://*.pusherapp.com https://*.pusherapp.com ws://*.pusherapp.com wss://*.pusherapp.com https://*.onrender.com https://cloudflareinsights.com https://*.googleapis.com https://firestore.googleapis.com https://*.firebaseio.com https://*.cloudfunctions.net https://*.firebase.googleapis.com https://*.gstatic.com ws://localhost:* wss://localhost:* http://localhost:* https://localhost:* blob: data:; worker-src 'self' blob:; child-src 'self' blob:; object-src 'none'; base-uri 'self'; form-action 'self';",
          },
          {
