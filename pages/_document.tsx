        ...
        <Head>
          ...
          <meta
            ...
            content={`default-src 'self'; 
                      ...
                      connect-src 'self' https://*.gigaaura.com https://*.onrender.com https://cloudflareinsights.com https://*.googleapis.com https://firestore.googleapis.com https://*.firebaseio.com https://*.cloudfunctions.net https://*.firebase.googleapis.com https://*.gstatic.com wss://*.pusher.com https://*.pusher.com wss://*.pusherapp.com https://*.pusherapp.com;
