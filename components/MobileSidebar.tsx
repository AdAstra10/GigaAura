...
const MobileSidebar: React.FC<MobileSidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      {/* Overlay - Remove background classes */}
      <div
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-4/5 max-w-xs bg-white dark:bg-black text-black dark:text-white shadow-xl z-60 transform transition-transform duration-300 ease-in-out ${
