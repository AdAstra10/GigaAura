/**
 * Legacy Firebase Database Service for GigaAura (DEPRECATED)
 * 
 * This is a legacy adapter for Firebase that is maintained for backward compatibility only.
...
console.warn(
  'DEPRECATED: The Legacy Firebase database service is deprecated and will be removed in a future update. ' +
...
if (typeof window !== 'undefined') {
  try {
    ...
    console.warn('Failed to initialize Firebase cache from localStorage:', e);
  }
}

/**
 * Save a post to the local storage (Firebase is deprecated)
 */
export const savePost = async (post: Post): Promise<boolean> => {
  console.warn('Using deprecated Firebase service for saving post');
...
/**
 * Get all posts from local storage (Firebase is deprecated)
 */
export const getPosts = async (): Promise<Post[]> => {
  console.warn('Using deprecated Firebase service for getting posts');
  return postsCache;
};

/**
 * Get a post by ID from local storage (Firebase is deprecated)
 */
export const getPost = async (id: string): Promise<Post | null> => {
  console.warn('Using deprecated Firebase service for getting post by ID');
...
/**
 * Delete a post from local storage (Firebase is deprecated)
 */
export const deletePost = async (id: string): Promise<boolean> => {
  console.warn('Using deprecated Firebase service for deleting post');
...
/**
 * Save aura points to local storage (Firebase is deprecated)
 */
export const saveAuraPoints = async (walletAddress: string, auraPoints: number | AuraPointsState, transaction?: AuraTransaction): Promise<boolean> => {
  console.warn('Using deprecated Firebase service for saving aura points');
  ...
  if (typeof window !== 'undefined') {
    try {
      ...
      // Handle both number and AuraPointsState
      if (typeof auraPoints === 'number') {
        pointsData.totalPoints = auraPoints;
      } else {
        pointsData = auraPoints;
      }
...
/**
 * Add a transaction to aura points (Firebase is deprecated)
 */
export const addTransaction = async (walletAddress: string, transaction: AuraTransaction): Promise<boolean> => {
  console.warn('Using deprecated Firebase service for adding transaction');
  ...
  if (typeof window !== 'undefined') {
    try {
      ...
      pointsData.transactions = [transaction, ...pointsData.transactions];
      pointsData.totalPoints += transaction.amount;
...
/**
 * Get aura points from local storage (Firebase is deprecated)
 */
export const getAuraPoints = async (walletAddress: string): Promise<AuraPointsState | null> => {
  console.warn('Using deprecated Firebase service for getting aura points');
